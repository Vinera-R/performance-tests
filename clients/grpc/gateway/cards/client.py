...
class CardsGatewayGRPCClient(GRPCClient):
    def __init__(self, channel: Channel):
        """Инициализирует gRPC клиент для карт.

        :param channel: Объект канала связи gRPC."""
    ...
    def issue_virtual_card_api(self, request: IssueVirtualCardRequest) -> IssueVirtualCardResponse:
        """
                Делает прямой вызов метода CardsGatewayService.IssueVirtualCard.

                :param request: Объект запроса IssueVirtualCardRequest.
                :return: Объект ответа IssueVirtualCardResponse.
                """
    ...
    def issue_physical_card_api(self, request: IssuePhysicalCardRequest) -> IssuePhysicalCardResponse:
        """
        :param request: Объект запроса IssuePhysicalCardRequest.
        :return: Объект ответа IssuePhysicalCardResponse.
        """
    ...
    def issue_virtual_card(self,  user_id: str, account_id: str) -> IssueVirtualCardResponse:
        """
                ...
                :return: Ответ сервиса о выпуске карты.
                """
    ...
    def build_cards_gateway_grpc_client() -> CardsGatewayGRPCClient:
        """    Фабрика для создания экземпляра CardsGatewayGRPCClient.
               :return: :return: Инициализированный клиент для CardsGatewayGRPCClient.
       """
